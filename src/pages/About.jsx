  ...
  return (
    <div className="d-flex flex-column gap-4 my-2">
      ...
      <div className="glass-card">
        ...
        <p className="mb-0">
          We believe in constructing blazing-fast, serverless interfaces that respect user privacy. All text data processed in <strong>TextCraft</strong> remains entirely within your local browser sandbox. No characters, paragraphs, or credentials are ever transmitted over external networks. This makes TextCraft highly private, fast, and completely secure.
        </p>
      </div>
    </div>
  );
